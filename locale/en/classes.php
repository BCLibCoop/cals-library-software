...
$trans["biblioFieldError3"]       = "\$text = 'Letters and Numbers only.';";
$trans["biblioFieldError4"]       = "\$text = 'Sys Number Format is A?#?%break%Where A is an uppercase letter.%break%# is a digit.%break%? is any number of the preceding character.';";
#****************************************************************************
...
#****************************************************************************
$trans["biblioCopyError1"]        = "\$text = 'File Path is required.';";
$trans["biblioCopyError2"]        = "\$text = 'File Path must be a relative path to the downloadable file.';";

#****************************************************************************
#*  Translation text for class BiblioCopyQuery
#****************************************************************************
$trans["biblioCopyQueryErr1"]     = "\$text = 'Error checking for dup barcode.';";
$trans["biblioCopyQueryErr2"]     = "\$text = 'File Path %filePath% is already in use.';";
