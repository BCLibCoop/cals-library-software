...
#****************************************************************************
$trans["biblioViewTble1Hdr"]       = "\$text = 'Book Information';";
$trans["biblioViewMaterialType"]   = "\$text = 'Material Type';";
$trans["biblioViewCollection"]     = "\$text = 'Collection';";
$trans["biblioViewSaleable"]     = "\$text = 'On Sell Allowed';";
$trans["biblioViewCallNmbr"]       = "\$text = 'Call Number';";
$trans["biblioViewTble2Hdr"]       = "\$text = 'Book Download Information';";
$trans["biblioViewTble2Col1"]      = "\$text = 'Barcode #';";
$trans["biblioViewTble2Col2"]      = "\$text = 'Download Link';";
...
$trans["biblioViewTble3Hdr"]       = "\$text = 'Additional Book Information';";
...
#****************************************************************************
$trans["biblioSearchNoResults"]    = "\$text = 'No results found. Returning to search page in 10 seconds. <a href=\"request-new.php\">Request a new title</a>';";
...
$trans["biblioSearchDetail"]       = "\$text = 'Show detailed Book information';";
...
$trans["userLoginFormTbleHdr"]         = "\$text = 'Client Login';";
...
$trans["tabNameHome"]               = "\$text='Home';";
$trans["tabNameUsers"]        		= "\$text='Users';";
$trans["tabNameCatalog"]         = "\$text='Catalog';";
$trans["tabNameAdmin"]              = "\$text='Admin';";
$trans["tabNameReports"]            = "\$text='Reports';";
$trans["tabNameDevices"]            = "\$text='Devices';";

#****************************************************************************
#*  Translation text for page footer_admin.php
#****************************************************************************
