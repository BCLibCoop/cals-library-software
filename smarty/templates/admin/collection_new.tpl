...
<form name="newcollectionform" method="POST" action="../admin/collections_list.php">
...
<table class="adminTable">
    ...
    <tr>
      <td align="center" colspan="2" class="primary">
         <input type="button" onClick="javascript:this.form.action='collection_new.php';this.form.submit();" value="{$submitButtonLabel}" class="button">
