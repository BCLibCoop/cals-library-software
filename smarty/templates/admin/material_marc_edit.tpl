...
<input type="hidden" name="cd" value="{$fieldId}">
...
<td align="left" class="right">{html_inputField type=$fields.show.field.type name=$fields.show.field.name value=$fields.show.field.value checked=$fields.show.field.checked}
		...
		<tr >
		  <td align="center" colspan="2" class="primary">
		     <input type="button" onClick="javascript:this.form.action='material_marc_edit.php';this.form.submit();" value="{$submitButtonLabel}" class="button">
