...
<input type="hidden" id="hvendid" name="ven"  value="{$fields.vend.value}"/>
<input type="hidden" id="hprodid" name="pro"  value="{$fields.prod.value}"/>
<input type="hidden" id="hserial" name="ser"  value="{$fields.serial.value}"/>
...
<tr class="primary">
    ...
    <td align="left" class="right">
    	...
    	{html_inputField type=$fields.barcd.field.type name=$fields.barcd.field.name options=$fields.barcd.field.options}
    </td>
</tr>
<tr>
{if $error_barcode}
