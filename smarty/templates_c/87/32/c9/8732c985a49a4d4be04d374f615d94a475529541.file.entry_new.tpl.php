<?php /* Smarty version Smarty-3.1.13, created on 2013-04-11 09:52:12
         compiled from "/Library/WebServer/Documents/Library/openbiblio/smarty/templates/catalog/entry_new.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19100987355166174c9fa263-14299198%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8732c985a49a4d4be04d374f615d94a475529541' => 
    array (
      0 => '/Library/WebServer/Documents/Library/openbiblio/smarty/templates/catalog/entry_new.tpl',
      1 => 1365570927,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '19100987355166174c9fa263-14299198',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5166174ce070d7_81274607',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5166174ce070d7_81274607')) {function content_5166174ce070d7_81274607($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Library/WebServer/Documents/Library/openbiblio/libs/Smarty/plugins/modifier.date_format.php';
...
" onclick="self.location='catalog_search.php'" />
...
" onclick="self.location='entry_marc_edit.php?f=<?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['tidx']->value;?>
<?php $_tmp1=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['entryFields']->value[$_tmp1]->getFieldid();?>
...
<tr class="<?php if (!(1 & $_smarty_tpl->tpl_vars['rowidx']->value)){?>primary<?php }else{ ?>alt1<?php }?>">
	<td class="left"></td>
	<td><?php echo $_smarty_tpl->tpl_vars['collectionType']->value['label'];?>
</td>
	<td width="50%" class="right"><?php echo smarty_function_html_inputField(array('type'=>"select",'name'=>"colid",'selected'=>$_smarty_tpl->tpl_vars['collectionType']->value['selected'],'options'=>$_smarty_tpl->tpl_vars['collections']->value),$_smarty_tpl);?>
</td>
	<?php $_smarty_tpl->tpl_vars["rowidx"] = new Smarty_variable($_smarty_tpl->tpl_vars['rowidx']->value+1, null, 0);?>
</tr>
<tr class="<?php if (!(1 & $_smarty_tpl->tpl_vars['rowidx']->value)){?>primary<?php }else{ ?>alt1<?php }?>">
	<td class="left"></td>
	<td><?php echo $_smarty_tpl->tpl_vars['materialType']->value['label'];?>
</td>
	<td width="50%" class="right"><?php echo smarty_function_html_inputField(array('type'=>"select",'name'=>"matid",'selected'=>$_smarty_tpl->tpl_vars['materialType']->value['selected'],'options'=>$_smarty_tpl->tpl_vars['materials']->value,'onchange'=>"doMaterialChange(this.value);"),$_smarty_tpl);?>
</td>
...
?>
	...
	<td class="left" align="center"  width="8%"><?php if ($_smarty_tpl->tpl_vars['part']->value['required']){?><sup>*</sup><?php }?>&nbsp;<?php echo $_smarty_tpl->tpl_vars['tidx']->value;?>
</td>
	<td width="35%" ><?php if ($_smarty_tpl->tpl_vars['part']->value['required']){?><sup>*</sup><?php }?><?php echo $_smarty_tpl->tpl_vars['part']->value['desc'];?>
</td>
...
?>
	...
	<?php } ?>		
	<tr class="<?php if (!(1 & $_smarty_tpl->tpl_vars['rowidx']->value)){?>primary<?php }else{ ?>alt1<?php }?>">
	<td align="center" class="left" width="8%"><?php echo $_smarty_tpl->tpl_vars['tidx']->value;?>
</td>
	<td width="35%" ><?php if ($_smarty_tpl->tpl_vars['part']->value['required']){?><sup>*</sup><?php }?>&nbsp;<?php echo $_smarty_tpl->tpl_vars['part']->value['desc'];?>
</td>
...
"><?php }?>
	...
	<?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['error_fld_'.($_smarty_tpl->tpl_vars['tidx']->value)]->value;?>
<?php $_tmp4=ob_get_clean();?><?php if ($_tmp4){?><tr><td align="center" colspan="3" class="error"><?php echo $_smarty_tpl->tpl_vars['error_fld_'.($_smarty_tpl->tpl_vars['tidx']->value)]->value;?>
</td></tr><?php }?>
	<?php $_smarty_tpl->tpl_vars["rowidx"] = new Smarty_variable($_smarty_tpl->tpl_vars['rowidx']->value+1, true, 0);?>
<?php } ?>
