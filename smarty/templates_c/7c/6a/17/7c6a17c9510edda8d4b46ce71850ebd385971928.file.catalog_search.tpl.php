<?php /* Smarty version Smarty-3.1.13, created on 2013-04-10 14:00:50
         compiled from "/Library/WebServer/Documents/Library/openbiblio/smarty/templates/catalog/catalog_search.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1286297325516500122c4987-20563683%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7c6a17c9510edda8d4b46ce71850ebd385971928' => 
    array (
      0 => '/Library/WebServer/Documents/Library/openbiblio/smarty/templates/catalog/catalog_search.tpl',
      1 => 1365570927,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1286297325516500122c4987-20563683',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_516500124f6322_45524849',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_516500124f6322_45524849')) {function content_516500124f6322_45524849($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Library/WebServer/Documents/Library/openbiblio/libs/Smarty/plugins/modifier.date_format.php';
?>
...
<input disabled type="button" id="viewEntryButton" value="<?php echo $_smarty_tpl->tpl_vars['submitButtonLabel']->value;?>
" onclick="viewEntry();" >
...
<br/><input style="width:80%" maxlength="40" id="srchtitle" type="text" onkeyup="delayFunction(function() { checkField('srchtitle');},600);"></th>
    <th style="width:30%"><?php echo $_smarty_tpl->tpl_vars['searchBar']->value['author']['label'];?>
<br/><input style="width:80%" maxlength="30" id="srchauthor" type="text" onkeyup="delayFunction(function() { checkField('srchauthor');},600);"></th>
    <th style="width:30%"><?php echo $_smarty_tpl->tpl_vars['searchBar']->value['subject']['label'];?>
<br/><input style="width:80%" maxlength="30" id="srchsubj" type="text" onkeyup="delayFunction(function() { checkField('srchsubj');},600);"></th>
    <th class="right"  ><?php echo $_smarty_tpl->tpl_vars['searchBar']->value['snum']['label'];?>
<br/><input style="width:80%" maxlength="20" id="srchsnum" type="text" onkeyup="delayFunction(function() { checkField('srchsnum');},600);"></th>
</tr>
</thead>
</table>
</div>
