<?php /* Smarty version Smarty-3.1.13, created on 2013-04-10 14:36:27
         compiled from "/Library/WebServer/Documents/Library/openbiblio/smarty/templates/devices/device_edit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17300482795165086b2e3bb0-19002270%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e9b8ee296cd06f4842328597f60f73472d122252' => 
    array (
      0 => '/Library/WebServer/Documents/Library/openbiblio/smarty/templates/devices/device_edit.tpl',
      1 => 1365570927,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '17300482795165086b2e3bb0-19002270',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5165086b492da5_81763340',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5165086b492da5_81763340')) {function content_5165086b492da5_81763340($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Library/WebServer/Documents/Library/openbiblio/libs/Smarty/plugins/modifier.date_format.php';
...
<input type="hidden" id="huserid" name="uid" value="<?php echo $_smarty_tpl->tpl_vars['uid']->value;?>
" />
<input type="hidden" id="hdevid" name="did"  value="<?php echo $_smarty_tpl->tpl_vars['did']->value;?>
"/>
<input type="hidden" id="husername" name="unm"  value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['username']['value'];?>
"/>
<input type="hidden" id="hfullname" name="fnm"  value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['name']['value'];?>
"/>
<div style="width:50%">
...
<tr class="primary">
    ...
    <?php if ($_smarty_tpl->tpl_vars['fields']->value['barcd']['field']['value']&&!$_smarty_tpl->tpl_vars['error_barcode']->value){?>
        <input type="hidden" name="bcd"  value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['barcd']['field']['value'];?>
"/>
    	<?php echo $_smarty_tpl->tpl_vars['fields']->value['barcd']['field']['value'];?>
    ...
    <?php }else{ ?>
    	...
    	<?php echo smarty_function_html_inputField(array('type'=>"text",'name'=>"bcd",'options'=>$_smarty_tpl->tpl_vars['fields']->value['barcd']['field']['options']),$_smarty_tpl);?>
