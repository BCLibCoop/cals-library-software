<?php /* Smarty version Smarty-3.1.13, created on 2013-04-10 15:45:13
         compiled from "/Library/WebServer/Documents/Library/openbiblio/smarty/templates/users/user_del.tpl" */ ?>
<?php /*%%SmartyHeaderCode:66583467751651889425f54-67732363%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8f4e8c7bf3425987a36dd9879ca35bed67e7b878' => 
    array (
      0 => '/Library/WebServer/Documents/Library/openbiblio/smarty/templates/users/user_del.tpl',
      1 => 1365570927,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '66583467751651889425f54-67732363',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_516518895aff51_08117788',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_516518895aff51_08117788')) {function content_516518895aff51_08117788($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Library/WebServer/Documents/Library/openbiblio/libs/Smarty/plugins/modifier.date_format.php';
?>
...
<center>
<font class="error"><?php echo $_smarty_tpl->tpl_vars['deleteConfirmMsg']->value;?>
</font><br/>
<form name="delform" method="get" action="user_view.php?uid=<?php echo $_smarty_tpl->tpl_vars['uid']->value;?>
">
<br><br>
	  <input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['uid']->value;?>
" name="uid">
	  <input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['postedVal']->value['value'];?>
" name="<?php echo $_smarty_tpl->tpl_vars['postedVal']->value['name'];?>
">
      <input type="button" value="<?php echo $_smarty_tpl->tpl_vars['submitButton']->value['label'];?>
" onclick="<?php echo $_smarty_tpl->tpl_vars['submitButton']->value['onclick'];?>
" >
      <input type="submit" value="<?php echo $_smarty_tpl->tpl_vars['cancelButton']->value['label'];?>
" >
</form>
</center>
