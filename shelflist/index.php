...
switch ($material){
	...
	case "17":
		...
		while ($row_ta = mysql_fetch_array($sqlresults_ta)) {
			...
			$uid = $row_ta['bibid'];
			$url = "http://www.galloplibrary.org/cals/opac/view.php?b=$uid";
			...
			$bookreport .= "<p class=\"pbreak\"><strong><a href=\"http://www.galloplibrary.org/cals/opac/view.php?b=$uid\">$title</a></strong>\n<br/><strong>$s</strong> $playtime<br/>\nby $author$narrator$summary</p>\n\n";
