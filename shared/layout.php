 ...
 */
  ...
  if ($tab != 'opac') {
    require_once(str_replace('//','/',dirname(__FILE__).'/')."../admin/adminLoginCheck.php");
  }
  ...
  if ($tab == 'opac') {
    include_once(str_replace('//','/',dirname(__FILE__).'/')."../shared/header_opac.php");
  } else {
    include_once(str_replace('//','/',dirname(__FILE__).'/')."../shared/header-old.php");
  }
