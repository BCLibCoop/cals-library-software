 ...
 */
   ...
   ****************************************************************************
   */
  include_once(str_replace('//','/',dirname(__FILE__).'/')."../classes/Settings.php");
  include_once(str_replace('//','/',dirname(__FILE__).'/')."../classes/SettingsQuery.php");
 // require_once(str_replace('//','/',dirname(__FILE__).'/')."../classes/Theme.php");
 //require_once(str_replace('//','/',dirname(__FILE__).'/')."../classes/ThemeQuery.php");
  include_once(str_replace('//','/',dirname(__FILE__).'/')."../functions/errorFuncs.php");
