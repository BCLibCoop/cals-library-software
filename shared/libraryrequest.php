...
if ($_POST['submit']) {
	include("configlibrequest.inc");
	
	$libraryname = addslashes($_POST['libraryname']);
	...
	$uri = "http://www.cucat.org" . $_POST['uri'];
	$refnumber = addslashes($_POST['refnumber']);
	
	
	if ($lname and $gname and $address1 and $city and $email) {
...
if ($tape) {$format_list = $format_list . "Tape, ";}
...
<p>You are requesting the following title be produced as a digital talking book:</p>
...
<form action="libraryrequest.php" method="post" name="orderform" >
    
    <fieldset><legend>Information</legend>
      <div class="notes">
        <h4>Information</h4>
        <p class="last">Please enter your contact name, library name and address and other information below. Your organisation will receive an invoice with the goods such as physical CD. There is no charge for books which are delivered by download from our servers. You will be contacted when the requested title has been produced.</p>
       </div>
       ...
       <h3>Contact Person</h3>
        ...
        <input type="text" name="gname" id="first_name" class="inputText" size="10" maxlength="100" value=""  onblur="addCheck(value)"/>
      </div>
      
        <div class="required">
        <label for="last_name">Last Name:</label>
        <input type="text" name="lname" id="last_name" class="inputText" size="10" maxlength="100" value=""  onblur="addCheck(value)"/>
       </div>
       ...
       <div class="required">
        ...
        <input type="text" name="libraryname" id="libraryname" class="inputText" size="10" maxlength="100" value=""  onblur="addCheck(value)"/>
      </div>
      
      <div class="required">
        
        <label for="address_1">Address:</label>
        <input type="text" name="address1" id="address_1" class="inputText" size="10" maxlength="100" value=""  onblur="addCheck(value)"/>
        <input type="text" name="address2" id="address_2" class="inputText" size="10" maxlength="100" value="" />
      </div>
      <div class="required">
        
        <label for="city">City:</label>
        <input type="text" name="city" id="city" class="inputText" size="10" maxlength="100" value=""  onblur="addCheck(value)"/>
      </div>
      <div class="required">
...
<option value="XX">XX - Other State/Province/Territory</option>
      ...
      <div class="required">
        ...
        <input type="text" name="postal" id="postal" class="inputText" size="10" maxlength="50" value=""  onblur="addCheck(value)"/>
      </div>
      <div class="optional">
...
<fieldset><legend>Contact Information</legend>
     ...
     <!-- <div class="required">
      ...
      <div class="required">
        ...
        <input type="text" name="email" id="email" class="inputText" size="10" maxlength="250" value=""  onblur="addCheck(value)"/>
     ...
     <!-- <div class="required">
      ...
      <div class="optional">
      <small>There is a A$19.99 charge for physical media delivery (CDs) only You may request production of a book and download such book without charge.</small>
      
      <fieldset><legend>Formats Requested:</legend>
          <label for="formats_checkbox_0" class="labelCheckbox">
          <input type="checkbox" name="daisy3" id="formats_checkbox_0" class="inputCheckbox" value="1" checked="true" disabled="true"/> DAISY wth MP3 playlists (always produced)</label>
          <!--
          <label for="formats_checkbox_1" class="labelCheckbox">
          <input type="checkbox" name="daisy2" id="formats_checkbox_1" class="inputCheckbox" value="1" /> DAISY version 2.02</label>
          ...
          <input type="checkbox" name="cd" id="formats_checkbox_6" class="inputCheckbox" value="1" /> Physical CD. (A$19.99)</label>
         
         <label for="formats_checkbox_7" class="labelCheckbox">
          <input type="checkbox" name="cd" id="formats_checkbox_7" class="inputCheckbox" value="1" /> Audio cassette tape</label>
         
        </fieldset>
      </div>
      <label for="refnumber">Order/Reference Number:</label>
        <input type="text" name="refnumber" id="refnumber" class="inputText" size="10" maxlength="50" value="" />
      </div>
</fieldset>
