...
if ($_POST['submit']) {
	//echo "the system number is: $sysNum";
	include("config.inc");
	...
	$epub = $_POST['epub'];
	$cd = $_POST['cd'];
	$title2 = addslashes($_POST['title']);
	$author2 = addslashes($_POST['author']);
...
function Hideme() {
            frmVal = document.orderform
            if (frmVal.libpatron.checked) 
            {
            	x = document.getElementById('Layer02');
...
<p><strong><?php echo "$title $sysNum"; ?> <input type="text" disabled="true" name="sysNum" value="<?php echo $sysNum ?>"/></strong><br/>
<em><?php echo $author; ?></em></p>

<p>Please fill out the form below and submit your request. The book will be produced and you will be notified when it is ready for download.</p>
<?php echo $message; ?>
<p><strong>Bold</strong> fields are required.</p>

<form action="newrequest.php" method="post" name="orderform">
    ...
    <!--
      ...
      <div class="required">
        ...
        <input type="text" name="gname" id="first_name" class="inputText" size="30" maxlength="100" value="" onblur="addCheck(value)"/>
      </div>
      <div class="required">
        
        <label for="last_name">Last Name:</label><br/>
        <input type="text" name="lname" id="last_name" class="inputText" size="30" maxlength="100" value="" onblur="addCheck(value)"/>
      </div>
...
<fieldset><legend>Contact Information</legend>
      ...
      <div class="required">
        ...
        <input type="text" name="email" id="email" class="inputText" size="30" maxlength="250" value="" onblur="addCheck(value)"/>
...
<input type="hidden"  name="sysNum" value="<?php echo $sysNum ?>"/>
