...
require_once(str_replace('//','/',dirname(__FILE__).'/')."../classes/BiblioStatusHist.php");
require_once(str_replace('//','/',dirname(__FILE__).'/')."../classes/SettingsQuery.php");
...
class BiblioStatusHistQuery extends Query {
  ...
  function queryByBibid($bibid) {
    ...
    $sql = $this->mkSQL("select biblio_status_hist.*, "
                        ...
                        . " biblio_copy.file_path biblio_file_path, "
                        ...
                        . "order by file_path, status_begin_dt ",
                        $bibid);
  ...
  function fetchRow() {
    ...
    $hist->setBiblioFilePath($array["biblio_file_path"]);
