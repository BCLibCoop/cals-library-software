...
require_once(str_replace('//','/',dirname(__FILE__).'/')."../classes/InstallQuery.php");
...
."(bibid,  copyid,copy_desc,file_path,  status_cd,                status_begin_dt,                       due_back_dt,   mbrid) select"
." b.bibid,null,  null,     b.file_path,ifnull(bs.status_cd,'in'),ifnull(bs.status_begin_dt,b.create_dt),bs.due_back_dt,bs.mbrid from "
          .$prfx."biblio as b "
