...
<?php } 
  ...
  if($nav == 'locsru')
  {
    echo '&raquo; ' . $navLoc->getText('LOCsearch') . "<br />\n";
  }
  else
  {
    echo '<a href="../catalog/locsru.php" class="alt1">' . $navLoc->getText('LOCsearch') . "</a><br />\n";
  }

/**
 * Added for Amazon module
 */
if($nav == 'amazon')
{
  echo '&raquo; ' . $navLoc->getText('amazon_Search') . "<br />\n";
}
else
{
  echo '<a href="../catalog/amazon.php" class="alt1">' . $navLoc->getText('amazon_Search') . "</a><br />\n";
}
?>
...
if($nav == 'recommend')
{
  echo '&raquo; ' . $navLoc->getText('catalogRecommendations') . "<br />\n";
}
else
{
  echo '<a href="../catalog/recommend.php" class="alt1">' . $navLoc->getText('catalogRecommendations') . "</a><br />\n";
}
?>
<br/>
