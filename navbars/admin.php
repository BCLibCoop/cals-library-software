...
<?php /* if ($nav == "classifications") { ?>
 &raquo; <?php echo $navLoc->getText("User Types");?><br>
<?php } else { ?>
 <a href="../admin/user_classify_list.php" class="alt1"><?php echo $navLoc->getText("User Types");?></a><br>
<?php } */?>
...
<!--
< ?php if ($nav == "devices") { ?>
 &raquo; < ?php echo $navLoc->getText("adminDevices"); ?><br>
< ?php } else { ?>
 <a href="../admin/devices_view.php" class="alt1"><?php echo $navLoc->getText("adminDevices"); ?></a><br>
< ?php } ?>
