 ...
 */
    ...
    class QRcode {
        ...
        //----------------------------------------------------------------------
        public static function pngData($text, $level = QR_ECLEVEL_L, $size = 3, $margin = 4, $back_color = 0xFFFFFF, $fore_color = 0x000000)
        {
           ...
           try {
                ...
                $imageData = QRimage::image($tab, min(max(1, $size), $maxSize), $margin, $back_color, $fore_color);
                ob_start();
                ImagePng($imageData);
                $png = ob_get_contents();
                ob_end_clean();
